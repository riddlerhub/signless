...
function getPieceLocations(){return{plum:{x:myPieces.plum.x,y:myPieces.plum.y},white:{x:myPieces.white.x,y:myPieces.white.y},peacock:{x:myPieces.peacock.x,y:myPieces.peacock.y},green:{x:myPieces.green.x,y:myPieces.green.y},scarlet:{x:myPieces.scarlet.x,y:myPieces.scarlet.y},mustard:{x:myPieces.mustard.x,y:myPieces.mustard.y}}}function updateGameBoard(e){let c=e.movement_info.current_locations;for(var y in c){let e=c[y].x,s=c[y].y,m=getIndex(e,s);myPieces[y].setDirectly(e,s),myPieces[y].setIndices(m.x,m.y),myGameBoard.clear(),myGameBoard.draw(drawPieces)}setRoomsOfPlayers(e)}